...
export default function Dashboard() {
  ...
  function PositionedMenu({ selectMonitors, setSelectMonitors }) {
      ...
      Swal.fire({
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            await api.delete(`monitors/admin/multiple-delete`, {
    ...
    const handleMultiPlayMonitors = async () => {
      try {
        const response = await api.put(`/monitors/admin/multi-play`, {
          ids: selectMonitors,
        })
        Swal.fire({
          icon: 'success',
    ...
    const handleMultiPauseMonitors = async () => {
      try {
        const response = await api.put(`/monitors/admin/multi-pause`, {
          ids: selectMonitors,
        })
        Swal.fire({
          icon: 'success',
  ...
  useEffect(() => {
    const fetchMonitors = async () => {
      try {
        const response = await api.get(`monitors/admin/${params.userId}`)
        if (response.data) {
